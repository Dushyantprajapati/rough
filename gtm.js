...
return null},yd=!1;if(H.querySelectorAll)try{var zd=H.querySelectorAll(":root");zd&&1==zd.length&&zd[0]==H.documentElement&&(yd=!0)}catch(a){}var sd=yd;var Nd={},K=null,Od=Math.random();Nd.C="GTM-TZZBRK5";Nd.Ub="8j2";Nd.Nh="";var Pd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Qd="www.googletagmanager.com/gtm.js";
...
f))}if(void 0!==f&&0>=f)return!0;(d=d.parentElement)&&(e=F.getComputedStyle(d,null))}return!1};var wl=[],xl=!(!F.IntersectionObserver||!F.IntersectionObserverEntry),yl=function(a,b,c){for(var d=new F.IntersectionObserver(a,{threshold:c}),e=0;e<b.length;e++)d.observe(b[e]);for(var f=0;f<wl.length;f++)if(!wl[f])return wl[f]=d,f;return wl.push(d)-1},zl=function(a,b,c){function d(k,l){var p={top:0,bottom:0,right:0,left:0,width:0,height:0},n={boundingClientRect:k.getBoundingClientRect(),
intersectionRatio:l,intersectionRect:p,isIntersecting:0<l,rootBounds:p,target:k,time:Ha()};I(function(){return a(n)})}for(var e=[],f=[],h=0;h<b.length;h++)e.push(0),f.push(-1);c.sort(function(k,l){return k-l});return function(){for(var k=0;k<b.length;k++){var l=ul(b[k]);if(l>e[k])for(;f[k]<c.length-1&&l>=c[f[k]+1];)d(b[k],l),f[k]++;else if(l<e[k])for(;0<=f[k]&&l<=c[f[k]];)d(b[k],l),f[k]--;e[k]=l}}},Al=function(a,b,c){for(var d=0;d<c.length;d++)1<c[d]?c[d]=1:0>c[d]&&(c[d]=0);if(xl){var e=!1;I(function(){e||
zl(a,b,c)()});return yl(function(f){e=!0;for(var h={$a:0};h.$a<f.length;h={$a:h.$a},h.$a++)I(function(k){return function(){return a(f[k.$a])}}(h))},b,c)}return F.setInterval(zl(a,b,c),1E3)},Bl=function(a){xl?0<=a&&a<wl.length&&wl[a]&&(wl[a].disconnect(),wl[a]=void 0):F.clearInterval(a)};
var Cl=function(a,b,c){function d(){var h=a();f+=e?(Ha()-e)*h.playbackRate/1E3:0;e=Ha()}var e=0,f=0;return{$b:function(h,k,l){var p=a(),n=p.ie,r=void 0!==l?Math.round(l):void 0!==k?Math.round(p.ie*k):Math.round(p.wg),t=void 0!==k?Math.round(100*k):0>=n?0:Math.round(r/n*100),q=H.hidden?!1:.5<=ul(c);d();var u=Xk(c,"gtm.video",[b]);u["gtm.videoProvider"]="youtube";u["gtm.videoStatus"]=h;u["gtm.videoUrl"]=p.url;u["gtm.videoTitle"]=p.title;u["gtm.videoDuration"]=Math.round(n);u["gtm.videoCurrentTime"]=
Math.round(r);u["gtm.videoElapsedTime"]=Math.round(f);u["gtm.videoPercent"]=t;u["gtm.videoVisible"]=q;Mk(u)},zh:function(){e=Ha()},Tc:function(){d()}}};var Dl=F.clearTimeout,El=F.setTimeout,V=function(a,b,c){if(Bg()){b&&I(b)}else return Mc(a,b,c)},Fl=function(){return new Date},Gl=function(){return F.location.href},Hl=function(a){return Me(Oe(a),"fragment")},Il=function(a){return Ne(Oe(a))},Jl=function(a,b){return ye(a,b||2)},Kl=function(a,b,c){var d;b?(a.eventCallback=b,c&&(a.eventTimeout=c),d=Mk(a)):d=Mk(a);return d},Ll=function(a,b){F[a]=b},W=function(a,b,c){b&&
...
Z.a.ytl=["google"],function(){function a(){var w=Math.round(1E9*Math.random())+"";return H.getElementById(w)?a():w}function b(w,z){if(!w)return!1;for(var x=0;x<t.length;x++)if(0<=w.indexOf("//"+t[x]+"/"+z))return!0;return!1}function c(w){var z=-1!==w.indexOf("?")?"&":"?";if(-1<w.indexOf("origin="))return w+z+"enablejsapi=1";if(!u){var x=W("document");u=x.location.protocol+"//"+x.location.hostname;x.location.port&&(u+=":"+x.location.port)}return w+z+"enablejsapi=1&origin="+encodeURIComponent(u)}function d(w,
z){var x=w.getAttribute("src");if(b(x,"embed/")){if(0<x.indexOf("enablejsapi=1"))return!0;if(z)return w.setAttribute("src",c(x)),!0}return!1}function e(w,z){if(!w.getAttribute("data-gtm-yt-inspected-"+z.Bd)&&(w.setAttribute("data-gtm-yt-inspected-"+z.Bd,"true"),d(w,z.pe))){w.id||(w.id=a());var x=W("YT"),B=x.get(w.id);B||(B=new x.Player(w.id));var A=h(B,z),y={},C;for(C in A)y.ab=C,A.hasOwnProperty(y.ab)&&B.addEventListener(y.ab,function(G){return function(L){return A[G.ab](L.data)}}(y)),y={ab:y.ab}}}
function f(w){I(function(){function z(){for(var B=x.getElementsByTagName("iframe"),A=B.length,y=0;y<A;y++)e(B[y],w)}var x=W("document");z();il(z)})}function h(w,z){var x,B;function A(){Y=Cl(function(){return{url:M,title:T,ie:J,wg:w.getCurrentTime(),playbackRate:R}},z.Bd,w.getIframe());J=0;T=M="";R=1;return y}function y(da){switch(da){case q.PLAYING:J=Math.round(w.getDuration());M=w.getVideoUrl();if(w.getVideoData){var ja=w.getVideoData();T=ja?ja.title:""}R=w.getPlaybackRate();z.og?Y.$b("start"):Y.Tc();
N=p(z.rh,z.qh,w.getDuration());return C(da);default:return y}}function C(){ra=w.getCurrentTime();oa=Fl().getTime();Y.zh();ta();return G}function G(da){var ja;switch(da){case q.ENDED:return P(da);case q.PAUSED:ja="pause";case q.BUFFERING:var fc=w.getCurrentTime()-ra;ja=1<Math.abs((Fl().getTime()-oa)/1E3*R-fc)?"seek":ja||"buffering";w.getCurrentTime()&&(z.ng?Y.$b(ja):Y.Tc());O();return L;case q.UNSTARTED:return A(da);default:return G}}function L(da){switch(da){case q.ENDED:return P(da);case q.PLAYING:return C(da);
case q.UNSTARTED:return A(da);default:return L}}function P(){for(;B;){var da=x;Dl(B);da()}z.mg&&Y.$b("complete",1);return A(q.UNSTARTED)}function U(){}function O(){B&&(Dl(B),B=0,x=U)}function ta(){if(N.length&&0!==R){var da=-1,ja;do{ja=N[0];if(ja.Ja>w.getDuration())return;da=(ja.Ja-w.getCurrentTime())/R;if(0>da&&(N.shift(),0===N.length))return}while(0>da);x=function(){B=0;x=U;0<N.length&&N[0].Ja===ja.Ja&&(N.shift(),Y.$b("progress",ja.Ie,ja.Pe));ta()};B=El(x,1E3*da)}}var Y,N=[],J,M,T,R,ra,oa,Ta=A(q.UNSTARTED);
B=0;x=U;return{onStateChange:function(da){Ta=Ta(da)},onPlaybackRateChange:function(da){ra=w.getCurrentTime();oa=Fl().getTime();Y.Tc();R=da;O();ta()}}}function k(w){for(var z=w.split(","),x=z.length,B=[],A=0;A<x;A++){var y=parseInt(z[A],10);isNaN(y)||100<y||0>y||B.push(y/100)}B.sort(function(C,G){return C-G});return B}function l(w){for(var z=w.split(","),x=z.length,B=[],A=0;A<x;A++){var y=parseInt(z[A],10);isNaN(y)||0>y||B.push(y)}B.sort(function(C,G){return C-G});return B}function p(w,z,x){var B=
w.map(function(C){return{Ja:C,Pe:C,Ie:void 0}});if(!z.length)return B;var A=z.map(function(C){return{Ja:C*x,Pe:void 0,Ie:C}});if(!B.length)return A;var y=B.concat(A);y.sort(function(C,G){return C.Ja-G.Ja});return y}function n(w){w.vtp_triggerStartOption?r(w):fh(function(){r(w)})}function r(w){var z=!!w.vtp_captureStart,x=!!w.vtp_captureComplete,B=!!w.vtp_capturePause,A=k(w.vtp_progressThresholdsPercent+""),y=l(w.vtp_progressThresholdsTimeInSeconds+""),C=!!w.vtp_fixMissingApi;if(z||x||B||A.length||
y.length){var G={og:z,mg:x,ng:B,qh:A,rh:y,pe:C,Bd:void 0===w.vtp_uniqueTriggerId?"":w.vtp_uniqueTriggerId},L=W("YT"),P=function(){f(G)};I(w.vtp_gtmOnSuccess);if(L)L.ready&&L.ready(P);else{var U=W("onYouTubeIframeAPIReady");Ll("onYouTubeIframeAPIReady",function(){U&&U();P()});I(function(){for(var O=W("document"),ta=O.getElementsByTagName("script"),Y=ta.length,N=0;N<Y;N++){var J=ta[N].getAttribute("src");if(b(J,"iframe_api")||b(J,"player_api"))return}for(var M=O.getElementsByTagName("iframe"),T=M.length,
R=0;R<T;R++)if(!v&&d(M[R],G.pe)){V("https://www.youtube.com/iframe_api");v=!0;break}})}}else I(w.vtp_gtmOnSuccess)}var t=["www.youtube.com","www.youtube-nocookie.com"],q={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},u,v=!1;Z.__ytl=n;Z.__ytl.b="ytl";Z.__ytl.g=!0;Z.__ytl.priorityOverride=0}();



Z.a.gas=["google"],function(){(function(a){Z.__gas=a;Z.__gas.b="gas";Z.__gas.g=!0;Z.__gas.priorityOverride=0})(function(a){var b=D(a),c=b;c[Ib.Oa]=null;c[Ib.pf]=null;var d=b=c;d.vtp_fieldsToSet=d.vtp_fieldsToSet||[];var e=d.vtp_cookieDomain;void 0!==e&&(d.vtp_fieldsToSet.push({fieldName:"cookieDomain",value:e}),delete d.vtp_cookieDomain);return b})}();

Z.a.fsl=[],function(){function a(){var e=W("document"),f=c(),h=HTMLFormElement.prototype.submit;Qc(e,"click",function(k){var l=k.target;if(l&&(l=Vc(l,["button","input"],100))&&("submit"==l.type||"image"==l.type)&&l.name&&Sc(l,"value")){var p;l.form?l.form.tagName?p=l.form:p=H.getElementById(l.form):p=Vc(l,["form"],100);p&&f.store(p,l)}},!1);Qc(e,"submit",function(k){var l=k.target;if(!l)return k.returnValue;var p=k.defaultPrevented||!1===k.returnValue,n=b(l)&&!p,r=f.get(l),t=!0;if(d(l,function(){if(t){var q;
...
h})};return{store:function(h,k){var l=f(h);l?l.button=k:e.push({form:h,button:k})},get:function(h){var k=f(h);return k?k.button:null}}}function d(e,f,h,k,l){var p=al("fsl",h?"nv.mwt":"mwt",0),n;n=h?al("fsl","nv.ids",[]):al("fsl","ids",[]);if(!n.length)return!0;var r=Xk(e,"gtm.formSubmit",n),t=e.action;t&&t.tagName&&(t=e.cloneNode(!1).action);r["gtm.elementUrl"]=t;l&&(r["gtm.formSubmitElement"]=l);if(k&&p){if(!Kl(r,Nk(f),p))return!1}else Kl(r,function(){},p||2E3);return!0}(function(e){Z.__fsl=e;Z.__fsl.b=
"fsl";Z.__fsl.g=!0;Z.__fsl.priorityOverride=0})(function(e){var f=e.vtp_waitForTags,h=e.vtp_checkValidation,k=Number(e.vtp_waitForTagsTimeout);if(!k||0>=k)k=2E3;var l=e.vtp_uniqueTriggerId||"0";if(f){var p=function(r){return Math.max(k,r)};$k("fsl","mwt",p,0);h||$k("fsl","nv.mwt",p,0)}var n=function(r){r.push(l);return r};$k("fsl","ids",n,[]);h||$k("fsl","nv.ids",n,[]);Pl("fsl")||(a(),Ql("fsl"));I(e.vtp_gtmOnSuccess)})}();
...
Z.a.evl=["google"],function(){function a(){var f=Number(Jl("gtm.start"))||0;return Fl().getTime()-f}function b(f,h,k,l){function p(){if(!vl(f.target)){h.has(d.Tb)||h.set(d.Tb,""+a());h.has(d.Dc)||h.set(d.Dc,""+a());var r=0;h.has(d.Vb)&&(r=Number(h.get(d.Vb)));r+=100;h.set(d.Vb,""+r);if(r>=k){var t=Xk(f.target,"gtm.elementVisibility",[h.h]),q=ul(f.target);t["gtm.visibleRatio"]=Math.round(1E3*q)/10;t["gtm.visibleTime"]=k;t["gtm.visibleFirstTime"]=Number(h.get(d.Dc));t["gtm.visibleLastTime"]=Number(h.get(d.Tb));
Kl(t);l()}}}if(!h.has(d.fb)&&(0==k&&p(),!h.has(d.Pa))){var n=W("self").setInterval(p,100);h.set(d.fb,n)}}function c(f){f.has(d.fb)&&(W("self").clearInterval(Number(f.get(d.fb))),f.i(d.fb))}var d={fb:"polling-id-",Dc:"first-on-screen-",Tb:"recent-on-screen-",Vb:"total-visible-time-",Pa:"has-fired-"},e=function(f,h){this.element=f;this.h=h};e.prototype.has=function(f){return!!this.element.getAttribute("data-gtm-vis-"+f+this.h)};e.prototype.get=function(f){return this.element.getAttribute("data-gtm-vis-"+
f+this.h)};e.prototype.set=function(f,h){this.element.setAttribute("data-gtm-vis-"+f+this.h,h)};e.prototype.i=function(f){this.element.removeAttribute("data-gtm-vis-"+f+this.h)};(function(f){Z.__evl=f;Z.__evl.b="evl";Z.__evl.g=!0;Z.__evl.priorityOverride=0})(function(f){function h(){var z=!1,x=null;if("CSS"===l){try{x=td(p)}catch(G){oc(46)}z=!!x&&v.length!=x.length}else if("ID"===l){var B=H.getElementById(p);B&&(x=[B],z=1!=v.length||v[0]!==B)}x||(x=[],z=0<v.length);if(z){for(var A=0;A<v.length;A++){var y=
new e(v[A],q);c(y)}v=[];for(var C=0;C<x.length;C++)v.push(x[C]);0<=w&&Bl(w);0<v.length&&(w=Al(k,v,[t]))}}function k(z){var x=new e(z.target,q);z.intersectionRatio>=t?x.has(d.Pa)||b(z,x,r,"ONCE"===u?function(){for(var B=0;B<v.length;B++){var A=new e(v[B],q);A.set(d.Pa,"1");c(A)}Bl(w);if(n&&hl)for(var y=0;y<hl.length;y++)hl[y]===h&&hl.splice(y,1)}:function(){x.set(d.Pa,"1");c(x)}):(c(x),"MANY_PER_ELEMENT"===u&&x.has(d.Pa)&&(x.i(d.Pa),x.i(d.Vb)),x.i(d.Tb))}var l=f.vtp_selectorType,p;"ID"===l?p=String(f.vtp_elementId):
"CSS"===l&&(p=String(f.vtp_elementSelector));var n=!!f.vtp_useDomChangeListener,r=f.vtp_useOnScreenDuration&&Number(f.vtp_onScreenDuration)||0,t=(Number(f.vtp_onScreenRatio)||50)/100,q=f.vtp_uniqueTriggerId,u=f.vtp_firingFrequency,v=[],w=-1;h();n&&il(h);I(f.vtp_gtmOnSuccess)})}();
